...
namespace NetPro.Dapper.Expressions
{
    ...
    public static partial class DapperSmart
    {
        ...
        /// <returns></returns>
        public static int GetCountByDynamic<T>(this IDbConnection connection, PageFilterDto pageFilterDto, IDbTransaction transaction = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            var sb = new StringBuilder();
            ...
            return connection.Query<int>(sb.ToString(), dynamicParameters, transaction, true)?.ToList().FirstOrDefault() ?? default;
        }
        ...
        /// <param name="pageFilterDto"></param>
        /// <returns></returns>
        public static IEnumerable<T> GetListPagedByDynamic<T>(this IDbConnection connection, PageFilterDto pageFilterDto, IDbTransaction transaction = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            var sb = new StringBuilder();
        ...
        private static KeyValuePair<string, object> SetSqlFilterAndParameterByMysql(PageFilterDto.FilterDto filterDto)
        {
            ...
            return new KeyValuePair<string, object>(sql, val);
        }
