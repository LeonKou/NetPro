    ...
    public class XMLProcess
    {
        ...
        private XmlDocument XMLLoad()
        {
            ...
            try
            {
                ...
                var fileprovide = EngineContext.Current.Resolve<INetProFileProvider>();
                string filename = fileprovide.MapPath(XMLFile);
        ...
        private static XmlDocument XMLLoad(string strPath)
        {
            ...
            try
            {
                ...
                var fileprovide = EngineContext.Current.Resolve<INetProFileProvider>();
                string filename = fileprovide.MapPath(strPath);
        ...
        private static string GetXmlFullPath(string strPath)
        {
            ...
            {
                return EngineContext.Current.Resolve<INetProFileProvider>().MapPath(strPath);
            }
        }
        #endregion
        ...
        /// </summary>
        /// <param name="node">要查询的节点</param>
        public string[] ReadAllChildInnerText(string node)
        {
            int i = 0;
            string[] str = { };
            XmlDocument doc = XMLLoad();
